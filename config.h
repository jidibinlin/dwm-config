...
static const char col_gray3[]       = "#66ccff";
static const char col_gray4[]       = "#ff9933";
...
//static const char *tags[] = { "", "", "ﬄ", "", "5", "6", "7", "8", "9" };
...
static const char *dmenucmd[] = { "rofi", "-modi", "drun", "-terminal", "alacritty", "-show", "drun", "-show-icons", "-icon-theme", "Abyss-Ink-Suru", NULL};
